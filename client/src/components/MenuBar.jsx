...
const Menubar = () => {
    ...
    return (
        <nav className="bg-white px-5 py-4 d-flex justify-content-between align-items-center">
            <div className="d-flex align-item-center gap-2px">
                <img src="https://www.freeiconspng.com/uploads/blue-check-mark-transparent-png-21.png" alt="Logo" width={22} height={22} style={{ marginTop: '5px' }} />
            ...
            {userData ?
                (
                    ...
                    <div className="btn btn-outline-dark rounded-pl px-3">
